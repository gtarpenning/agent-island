...
[Download the latest release](https://github.com/gtarpenning/agent-island/releases/download/v1.6/AgentIsland-1.6.dmg) or build from source:
...
Agent Island installs hooks into `~/.claude/hooks/` and your Codex session history that communicate session state. The app listens for events and displays them in the notch overlay.
