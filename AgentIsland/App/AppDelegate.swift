...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // AgentRegistry bootstraps all agents (Claude hooks, Codex monitoring, etc.)
        Task { @MainActor in
            await AgentRegistry.shared.bootstrap()
        }
    ...
    private func ensureSingleInstance() -> Bool {
        let bundleID = Bundle.main.bundleIdentifier ?? "com.farouqaldori.AgentIsland"
